"""
Parallel Pipeline Agent 2: Münster, Mannheim, Karlsruhe, Augsburg, Wiesbaden, Mönchengladbach
"""
import asyncio, json, re, csv, httpx
from pathlib import Path
from playwright.async_api import async_playwright

CITIES = ['Münster', 'Mannheim', 'Karlsruhe', 'Augsburg', 'Wiesbaden', 'Mönchengladbach']
OUT_DIR = Path(r'C:\Users\steph\.qclaw-oversea\workspace\projects\chase\zahnarzte-leads\paralysis2')
OUT_DIR.mkdir(parents=True, exist_ok=True)
CSV_OUT = OUT_DIR / 'leads_agent2.csv'
