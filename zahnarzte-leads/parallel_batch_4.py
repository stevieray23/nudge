"""
Parallel Pipeline Agent 4: Magdeburg, Freiburg, Krefeld, Mainz, Lübeck, Erfurt
"""
import asyncio, re, csv, httpx
from pathlib import Path
from playwright.async_api import async_playwright

CITIES = ['Magdeburg', 'Freiburg im Breisgau', 'Krefeld', 'Mainz', 'Lübeck', 'Erfurt']
OUT_DIR = Path(r'C:\Users\steph\.qclaw-oversea\workspace\projects\chase\zahnarzte-leads\paralysis4')
OUT_DIR.mkdir(parents=True, exist_ok=True)
CSV_OUT = OUT_DIR / 'leads_agent4.csv'
