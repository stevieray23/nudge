"""
Parallel Pipeline Agent 5: Dresden, Leipzig, Nürnberg, Stuttgart, Düsseldorf, Dortmund
"""
import asyncio, re, csv, httpx
from pathlib import Path
from playwright.async_api import async_playwright

CITIES = ['Dresden', 'Leipzig', 'Nürnberg', 'Stuttgart', 'Düsseldorf', 'Dortmund']
OUT_DIR = Path(r'C:\Users\steph\.qclaw-oversea\workspace\projects\chase\zahnarzte-leads\paralysis5')
OUT_DIR.mkdir(parents=True, exist_ok=True)
CSV_OUT = OUT_DIR / 'leads_agent5.csv'
