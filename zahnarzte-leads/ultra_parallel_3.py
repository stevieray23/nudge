"""
Ultra-fast city scraper - Group 3 (7 large cities, 3 parallel browsers)
"""
import asyncio, json, re, csv, httpx
from pathlib import Path
from playwright.async_api import async_playwright

CITIES = ['Krefeld','Mainz','Lübeck','Erfurt','Dresden','Leipzig','Nürnberg','Stuttgart','Düsseldorf','Dortmund','Berlin','Hamburg','Hannover','München','Köln']
BASE = Path(r'C:\Users\steph\.qclaw-oversea\workspace\projects\chase\zahnarzte-leads')
OUT = BASE / 'v2_batch3.json'
